        	...
        	<div class="card">
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						 ...
						 <p><small><a href="javascript:void(0)" class="view_schedule" data-id="<?php echo $row['id'] ?>" data-name="<?php echo "Dr. ".$row['name'].', '.$row['name_pref'] ?>"><i class='fa fa-calendar'></i>Programme</a></b></small></p>
						 <p><b>Specialties:</b></p>
					...
					<div class="col-md-3 text-center align-self-end-sm">
						<button class="btn-outline-primary  btn  mb-4 set_appointment" type="button" data-id="<?php echo $row['id'] ?>"  data-name="<?php echo "Dr. ".$row['name'].', '.$row['name_pref'] ?>">Fixer un rendez-vous</button>
					</div>
				</div>
